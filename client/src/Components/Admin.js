...
class Admin extends React.Component {
  ...
  debugFiller() {
    ...
    this.setState({
      instituteAddress: "",
      instituteName: "Thapathali Engineering Campus",
      instituteAcronym: "TEC",
      instituteWebsite: "https://www.tec.edu.np/",
      instituteCourses: new Map([
        [1, "Bachelors in Electronics, Communication and Information Engineering"],
        [2, "Bachelors in Computer Engineering"],
        [3, "Bachelors in Civil Engineering"],
        [3, "Bachelors in Mechanical Engineering"],
      ]),
    });
  }
